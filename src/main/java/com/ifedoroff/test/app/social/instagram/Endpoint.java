...
public abstract class Endpoint {
    ...
    public static final String ACCOUNT_MEDIAS_IN_RANGE = "https://www.instagram.com/{{username}}/media?min_id={{minId}}&max_id={{maxId}}";
    ...
    public static String getAccountMediasJsonLinkInRange(String username,String minId, String maxId) {
        if (maxId == null) {
            maxId = "";
        }
        return ACCOUNT_MEDIAS_IN_RANGE.replace("{{username}}", username).replace("{{maxId}}", maxId).replace("{{minId}}", minId);
    }
